...
#include "../omis/scope.h"

namespace eokas {
    struct coder_t :public omis_module_t {
        bool encode_module(ast_node_module_t *node) {
            ...
            omis_func_t* func = this->create_func("$main", ret, args);
        ...
        omis_value_t *encode_expr_int(ast_node_literal_int_t *node) {
            ...
            return this->constant_integer(vals, bits);
        }
        ...
        omis_value_t *encode_expr_float(ast_node_literal_float_t *node) {
            ...
            return this->constant_float(node->value);
        }

        omis_value_t *encode_expr_bool(ast_node_literal_bool_t *node) {
            if (node == nullptr)
                return nullptr;
            return this->constant_bool(node->value);
        }
